...
import 'package:invested/pages/account/support_settings/privacy_policy_text.dart';
          ...
          body: SingleChildScrollView(
            child: Column(
              children: [
                ...
                const PolicyText(
                  text: "     At InvestEd, accessible from investedfinancialeducation.com, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by InvestEd and how we use it.",
                ),
                const PolicyText(
                  text: "     If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us.",
                ),
                const PolicyText(
                  text: "     This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in InvestEd. This policy is not applicable to any information collected offline or via channels other than this website. Our Privacy Policy was created with the help of the Free Privacy Policy Generator",
                ),
                Container(
                ...
                const PolicyText(
                  text: "     You may consult this list to find the Privacy Policy for each of the advertising partners of InvestEd."
                ),
                const PolicyText(
                  text: "     Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in their respective advertisements and links that appear on InvestEd, which are sent directly to users' browser. They automatically receive your IP address when this occurs. These technologies are used to measure the effectiveness of their advertising campaigns and/or to personalize the advertising content that you see on websites that you visit.",
                ),
                const PolicyText(
                  text: "     Note that InvestEd has no access to or control over these cookies that are used by third-party advertisers.",
                ),
                Container(
                    margin: const EdgeInsets.only(top: 15),
                    child:  const PageTitle(
                ...
                const PolicyText(
                  text: "     InvestEd's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of certain options. ",
                ),
                const PolicyText(
                ...
                const PolicyText(
                  text: "     InvestEd does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records."
                )
              ],
            )
          )
