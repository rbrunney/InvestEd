...
class _AccountDetailsPageState extends State<AccountDetailsPage> {
  ...
  Container buildCreateAccountButton() {
    return Container(
        ...
        child: LandingButton(onTap: (fnameController.text.isNotEmpty && lnameController.text.isNotEmpty && birthdayController.text.isNotEmpty)
            ? onSubmit : () {},
            text: 'Create Account', hasFillColor: true)
    );
  }
}