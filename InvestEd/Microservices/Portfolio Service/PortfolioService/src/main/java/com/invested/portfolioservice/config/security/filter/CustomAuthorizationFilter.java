package com.invested.portfolioservice.config.security.filter;
...
import com.invested.portfolioservice.models.security.JsonWebTokenUTIL;
...
public class CustomAuthorizationFilter extends OncePerRequestFilter {
    ...
    public UsernamePasswordAuthenticationToken generateUserPassAuthToken(DecodedJWT token) {
        ...
        Map<String, Object> principal = new HashMap<>() {{
            put("username", token.getSubject());
            put("email", token.getClaim("email").toString());
        }};
