            ...
            DefaultConsumer consumer = new DefaultConsumer(channel) {
                ...
                public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) {
                    ...
                    String emailBody = "<div>\n" +
                            "        <h1 style=\"text-align:center;\">User Information Updated!</h1>\n" +
                            "    </div>\n" +
                            "    <div>\n" +
                            "        <h2 style=\"text-align:center;\"> Hello, " + msgToMap.get("fname") + " " + msgToMap.get("lname") + "! </h3>\n" +
                            "    </div>" +
                            "    <div>\n" +
                            "        <h3 style=\"text-align:center;\"> Account Information Updated!</h3>\n";

                    new SendEmail(msgToMap.get("email"), "Account Information Updated!", emailBody);
                }
            };

            channel.basicConsume("updated-info-queue", true, consumer);
