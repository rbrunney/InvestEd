        ...
        try {
            ...
            DefaultConsumer consumer = new DefaultConsumer(channel) {
                ...
                public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) {
                    ...
                    String emailBody = "<h1> Forgot Password </h1>\n" +
                            "<h3> "  + msgToMap.get("verification-code") + " </h3>";

                    new SendEmail(msgToMap.get("email"), "Forgot Password", emailBody);
                }
            };

            channel.basicConsume("forgot-pass-queue", true, consumer);
